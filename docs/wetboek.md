# Wetboek Pino Pistool

## Wetstechnische informatie

| | |
|---|---|
| Overheidsorganisatie      | Hoge Raad Pino Pistool |
| Officiële naam            | Algemeen Wetboek Pino Pistool |
| Citeertitel               | Wetboek Pino Pistool |
...
1. Het Wetboek Pino Pistool (verder aangeduid als WTDA) is leidend voor alle beschreven gevallen, waarbij als aanvulling het Nederlands Recht van toepassing is.
2. Het WTDA heeft betrekking op het vaste land, de gemeente, en de stad Pino Pistool.
3. Het WTDA is nauw verweven met de Algemene Plaatselijke Verordening Pino Pistool (APV). De APV dient echter als een indicerend kader voor eventuele bestraffing in-game (“in RP”) en is verder bedoeld voor het afhandelen van straffen buiten de RP om.
...
3. Minderjarigen worden binnen Pino Pistool op dezelfde manier behandeld als volwassenen. Alle bepalingen, straffen en dergelijke zijn ook van toepassing op hen. Minderjarigen hebben dezelfde rechten en plichten als volwassenen. Het jeugdstrafrecht is in Pino Pistool niet van toepassing.
...
3. Geldige redenen voor inbeslagname zijn:
    1. Plegen van een strafbaar feit uit het wetboek van Pino Pistool waarbij het goed direct of indirect betrokken is, met uitzondering van fout parkeren en snelheidsovertredingen zoals beschreven in lid 4;  
...
---------------------
*Wetboek Pino Pistool is opgesteld uit naam van de Hoge Raad, bedoeld voor de gemeente en de stad Pino Pistool, opgetekend door Ali Ilegalie - medal.exe, te Pino Pistool.*
